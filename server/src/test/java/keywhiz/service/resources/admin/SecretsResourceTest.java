...
public class SecretsResourceTest {
  ...
  Secret secret = new Secret(22, "name", "desc", () -> "secret", "hmac", NOW, "creator", NOW,
  ...
  public void listSecrets() {
    SanitizedSecret secret1 = SanitizedSecret.of(1, "name1", "hmac", "desc", NOW, "user", NOW, "user",
        emptyMap, null, null, 1136214245);
    SanitizedSecret secret2 = SanitizedSecret.of(2, "name2", "hmac", "desc", NOW, "user", NOW, "user",
        emptyMap, null, null, 1136214245);
