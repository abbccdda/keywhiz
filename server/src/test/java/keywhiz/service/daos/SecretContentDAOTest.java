...
public class SecretContentDAOTest {
  ...
  SecretContent secretContent1 = SecretContent.of(11, 22, "[crypted]", "hmac", date, "creator", date,
  ...
  @Test public void createSecretContent() {
    ...
    secretContentDAO.createSecretContent(secretContent1.secretSeriesId()+1, "encrypted", "hmac", "creator",
        metadata, 1136214245);
  ...
  @Test public void pruneOldContents() throws Exception {
    ...
    for (int i = 0; i < ids.length; i++) {
      long id = secretContentDAO.createSecretContent(
          secretSeriesId, "encrypted", "hmac", "creator", metadata, 1136214245);
      ids[i] = id;
    }
