...
public class SecretsDeliveryResourceTest {
  ...
  Secret firstSecret = new Secret(0, "first_secret_name", null,
      () -> Base64.getEncoder().encodeToString("first_secret_contents".getBytes(UTF_8)), "hmac", NOW, null, NOW, null, null,
      null, null, 0);
  ...
  Secret secondSecret = new Secret(1, "second_secret_name", null,
      () -> Base64.getEncoder().encodeToString("second_secret_contents".getBytes(UTF_8)), "hmac", NOW, null, NOW, null, null,
      null, null, 0);
