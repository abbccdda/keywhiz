...
public class SecretSeriesDAOTest {
  ...
  @Test public void setCurrentVersion() {
    ...
    long contentId = secretContentDAOFactory.readwrite().createSecretContent(id, "blah", "hmac", "creator", null, 0);
  ...
  public void setCurrentVersion_failsWithIncorrectSecretContent() {
    ...
    long contentId = secretContentDAOFactory.readwrite().createSecretContent(other, "blah", "hmac", "creator", null, 0);
