...
public class SecretDeliveryResourceTest {
  ...
  final Secret secret = new Secret(0, "secret_name", null, () -> "secret_value", "hmac", NOW, null, NOW, null,
      null, null, null, 0);
  final Secret secretBase64 = new Secret(1, "Base64With=", null, () -> "SGVsbG8=", "hmac", NOW, null, NOW,
  ...
  @Test public void returnsSecretWhenAllowed() throws Exception {
    Secret secret = new Secret(0, "secret_name", null, () -> "unused_secret", "hmac", NOW, null, NOW, null, null, null,
        null, 0);
  ...
  @Test public void returnsVersionedSecretWhenAllowed() throws Exception {
    ...
    Secret versionedSecret = new Secret(2, name, null, () -> "U3BpZGVybWFu", "hmac", NOW, null, NOW,
        null, null, null, null, 0);
